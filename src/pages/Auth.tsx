  ...
  const handleOnboardingSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateProfile({
        ...
        is_public: userType === 'hardware' ? true : false,
        rating: userType === 'hardware' ? 5.0 : 0,
        reviews_count: userType === 'hardware' ? 0 : 0,
      });
          ...
          {!isOnboarding ? (
            ...
            <form onSubmit={handleOnboardingSubmit} className="space-y-5">
              ...
              <button
               ...
               <dyad-write path="src/pages/Auth.tsx" description="Ajustando el onboarding para guardar el perfil persistente en la base de datos durante el primer login.">
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { supabase } from '@/integrations/supabase/client';
import { useSessionContext } from '@/components/auth/SessionContext';
        ...
        <div className="p-6 flex-1">
          {!isOnboarding ? (
            ...
            <form onSubmit={handleOnboardingSubmit} className="space-y-5">
              ...
              </<dyad-read path="src/pages/Auth.tsx"></dyad-read>
<dyad-read path="src/utils/toast.ts"></dyad-read>
<dyad-read path="src/components/auth/SessionContext.tsx"></dyad-read>Voy a terminar la persistencia real del perfil en Supabase y dejar el guardado del onboarding apuntando a la base de datos para que no se pierda tras recompilar.<dyad-write path="src/components/auth/SessionContext.tsx" description="Actualizando la sesión para persistir el perfil del usuario en Supabase y usarlo como fuente principal.">
