    ...
    <div className="min-h-screen bg-[hsl(var(--surface-0))] px-4 py-5 md:px-6 md:py-8">
      <div className="mx-auto flex min-h-[calc(100vh-2.5rem)] w-full max-w-6xl flex-col gap-4 md:min-h-[calc(100vh-4rem)]">
        <div className="flex items-center justify-between">
          <div>
            <p className="section-label">Onboarding de bienvenida</p>
            ...
            <div className="relative z-10 flex h-full flex-col justify-between gap-8">
              <div className="motion-safe:animate-[fade-up_500ms_ease-out]">
                ...
                <h2 className="font-display mt-6 max-w-xl text-3xl font-semibold leading-tight text-foreground md:text-5xl">
                  {isOnboarding
                    ? "Último paso: define tu perfil y activa tu operación."
                    : "Te damos la bienvenida a una experiencia de compras B2B más clara."}
                </h2>
                <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground md:text-base">
                  PIDO organiza solicitudes, ofertas y decisiones comerciales en un flujo simple. Primero te damos contexto, luego puedes entrar directo a tu cuenta o crear una nueva.
                </p>

                {!isOnboarding ? (
                  <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                    <Button type="button" onClick={() => setIsSignUp(true)} className="justify-center rounded-full px-6">
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-full border border-[hsl(var(--foreground)/0.1)] bg-[hsl(var(--surface-1)/0.86)] px-5 py-3 text-sm font-semibold text-foreground transition-all duration-200 hover:-translate-y-0.5 hover:border-[hsl(var(--primary)/0.28)] hover:bg-[hsl(var(--surface-1))]"
                    >
                      Ir directo al login
              ...
              <div className="grid gap-3 md:grid-cols-3 motion-safe:animate-[fade-up_700ms_ease-out]">
                ...
                <form onSubmit={handleAuth} className="space-y-5">
                  <div className="panel-muted p-4">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-foreground">
                      {isSignUp
                        ? "Crea tu cuenta y te llevamos al siguiente paso para completar tu perfil profesional o comercial."
                        : "Entra con tu cuenta si ya conoces la plataforma y quieres continuar sin pasos adicionales."}
                    </p>
                  </div>
