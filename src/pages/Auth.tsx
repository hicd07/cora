...
import { ArrowRight, Check, HardHat, Lock, LogIn, Mail, Moon, Store, SunMedium, User, UserPlus, FileText } from "lucide-react";
...
export const Auth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background px-4 py-6">
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-md flex-col justify-center gap-4">
        ...
        <div className="app-shell overflow-hidden rounded-2xl">
          <div className="border-b border-border bg-[hsl(var(--primary)/0.1)] px-6 py-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="section-label">Structural Precision</p>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Marketplace de subastas y abastecimiento para proyectos de construcción en Santo Domingo Este.
                </p>
              </div>
              <div className="flex h-12 w-12 items-center justify-center rounded-lg border border-primary/20 bg-primary text-primary-foreground">
              ...
              <form onSubmit={handleAuth} className="space-y-5">
                ...
                <div className="text-center">
                  <button
                    ...
                    className="font-display text-sm font-semibold text-primary transition-colors hover:opacity-80"
                  >
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "flex min-h-[136px] flex-col justify-between rounded-lg border p-4 text-left transition-colors",
                            isSelected
                              ? "border-primary/25 bg-[hsl(var(--primary)/0.12)]"
                              : "border-border bg-card hover:bg-accent",
                          )}
                        >
                          <div className="flex items-start justify-between gap-2">
                            <div className={cn("flex h-10 w-10 items-center justify-center rounded-md", isSelected ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground")}>
